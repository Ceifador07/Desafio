<div class="row my-3 border-bottom">
    ...
    <div class="col-sm-12 col-md-4 pt-2 text-end">
        <!-- <button class="btn btn-outline-success actionProduts" data-value="<?= BASE_URL ?>Admin/DadosProduto" data-bs-toggle="modal" data-bs-target="#Actual" data-id="<?= $produtos[0]->id ?>"><i class="fa-solid fa-edit mx-1"></i>Editar</button>
        <button class="btn btn-outline-danger  RemoveProduto" data-id="<?= $produtos[0]->id ?>" data-value="<?=BASE_URL?>Admin/DeletarProduto" id="0"><i class="fa-solid fa-trash mx-1"></i>Delete</button> -->
    </div>
</div>
<div class="row px-2">
    ...
    <div class="col-md-5">
        ...
        <div class="describe pt-2">
            <p>Nome do Cliente : <b><?= $produtos[0]->cliente ?></b></p>
           
        </div>
        <div class="describe ">
            <p class="">Quantidade em Requisitada</p>
        ...
        <div class="describe pt-2 ">
            <p class="">Valor a Pagar</p>
            <?php $total = $produtos[0]->preco * $produtos[0]->quantidade ?>
            <p><b><?= number_format($total,'2')?></b> MT</p>
        </div>
        <div class="describe ">
            <p class="">Status : <?= $produtos[0]->status ? $produtos[0]->status : "No-Ativo" ?></p>
        </div>

    </div>
    <div class="row justify-content-end">
        <div class="col-md-6 text-end ">
        <?php if($produtos[0]->status == 'Em Aberto' ||  $produtos[0]->status == 'Cancelado'){ ?>
            <button class="btn btn-primary">Efectuar o Pagamento</button>
            <?php }else{ ?>
                <button class="btn btn-primary" disabled>Efectuar o Pagamento</button>
            <?php } ?>
        </div>
    </div>
</div>
