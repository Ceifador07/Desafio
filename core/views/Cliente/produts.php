                ...
                <?php if (!empty($produtos)) {
                    foreach ($produtos as $produto) { ?>
                        <tr>
                            ...
                            <td>
                                <!-- <button class="btn btn-outline-primary actionProduts" data-value="<?= BASE_URL ?>Admin/DadosProduto" data-bs-toggle="modal" data-bs-target="#Actual" data-id="<?= $produto->id ?>"><i class="fa-solid fa-eye me-2"></i>Editar</button> -->
                                <a href="<?= BASE_URL ?>CLiente/Detalhes/<?= $produto->id ?>" class="btn btn-outline-info"><i class="fa-solid fa-info me-2"></i>Detalhe</a>
                            </td>
                        </tr>
                <?php }
                } ?>
