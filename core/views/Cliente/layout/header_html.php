            ...
            <div class="offcanvas offcanvas-start sindebar-var " data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <nav class="navbar-dark">
                        ...
                        <ul class="navbar-nav">
                            <li>
                                <i class="fa-solid fa-home"></i><a href="<?= BASE_URL ?>cliente/" class="nav-link">Inicio</a>
                            </li>
                            <li>
                                <i class="fa-solid fa-tasks"></i><a href="<?= BASE_URL ?>cliente/produts" class="nav-link">Produtos</a>
                            </li>
                            ...
                            <li class="nav-item  dropdown">
                                <a class="nav-link sindebar-link" href="#Exemplo" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseExamples">
                                    <span><i class="fa-solid fa-list"></i>Pedidos</span> <span class="right-icon"><i class="fa-solid fa-chevron-left "></i></span></a>
                            </li>

                            <div class="collapse" id="Exemplo">
                                <div class="card card-body">
                                    <ul class="navbar-nav">
                                        <li><i class="fa-solid fa-toolbox"></i><a href="<?= BASE_URL ?>cliente/Pedidos" class="nav-link">Todos</a></li>
                                        <li><i class="fa-solid fa-bell"></i><a href="<?= BASE_URL ?>cliente/notificacao" class="nav-link">Pesquisa Filtrada</a></li>
                                        <li><i class="fa-solid fa-bell"></i><a href="<?= BASE_URL ?>cliente/notificacao" class="nav-link">Pedentes</a></li>
                                    </ul>
                                </div>
                            </div>
                            <li>
                                <i class="fa-solid fa-bell"></i><a href="<?= BASE_URL ?>cliente/notificacao" class="nav-link">Notificação</a>
                            </li>
                            ...
                            <div class="collapse" id="collapseExample">
                                <div class="card card-body">
                                    <ul class="navbar-nav">
                                        <li><i class="fa-solid fa-toolbox"></i><a href="#" class="nav-link">Pedidos Pagos</a></li>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-color dropdown-menu-end ">
                                    <li class="d-flex"><a class="dropdown-item" href="<?= BASE_URL ?>cliente/settings">Definicoes <i class="fa-solid fa-gear m-1"></i></a></a></li>
